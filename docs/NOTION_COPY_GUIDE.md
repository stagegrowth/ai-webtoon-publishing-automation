...
| **고객 확인 체크리스트 (회사별)** | `asis/flow_confirmation.md` | Notion "고객 확인 체크리스트 (회사별)" + COMPANY-A/B/C As-Is Flow 페이지 | 수동 복사 |
...
- **로컬 파일**: `docs/asis/flow_confirmation.md`
...
- **용도**: **참고용 요약본**. 업로드 중심 5단계(ASIS-01~05) + **예외 비교 표(EX-01~05)** + **자동화 경계 표**를 한 문서에 담은 축약 버전입니다. Notion 동기화 대상이 아니며, 상세 회사별 Flow는 `asis/flow_confirmation.md`를 사용합니다.
...
- [ ] **고객 확인 체크리스트 (회사별)**: `asis/flow_confirmation.md` 내용을 Notion 해당 페이지에 반영했는지 확인
